...
/**
 * Servlet implementation class DeletadoDoCarrinho
 */
@WebServlet("/DeletadoDoCarrinho")
public class DeletadoDoCarrinho extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1>Produto deletado do carrinho com sucesso!</h1>");
